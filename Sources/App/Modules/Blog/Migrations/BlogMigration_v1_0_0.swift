    ...
    func prepare(on database: Database) -> EventLoopFuture<Void> {
        database.eventLoop.flatten([
            ...
            database.schema(BlogPostModel.schema)
                ...
                .foreignKey(BlogPostModel.FieldKeys.categoryId, references: BlogCategoryModel.schema, .id, onDelete: DatabaseSchema.ForeignKeyAction.setNull, onUpdate: .cascade)
            ...
            return [defaultCategory, islandsCategory].create(on: database).flatMap { [unowned defaultCategory] in
